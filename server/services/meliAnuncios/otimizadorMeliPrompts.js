...
function promptSeo(anuncio) {
  return [
    ...
    "- Exemplo bom (munhequeira crossfit):",
    '  "wrist wrap pulso protetor treino powerlifting crossfit academia halter barra kettlebell suporte punho"',
    "- Exemplo ruim (muito curto, parece frase):",
    '  "pulso academia levantamento peso grip antiderrapante"',
    "",
    "",
    "Score SEO (0 a 100):",

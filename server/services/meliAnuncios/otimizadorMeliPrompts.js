...
function promptSeo(anuncio) {
  return [
    ...
    "- O campo modelo NÃO é descrição e NÃO deve ser frase comercial.",
    "- O campo modelo NÃO deve repetir o título; ele complementa o",
    "  titulo_sugerido com termos de indexação.",
    "- Gere um conjunto curto de palavras-chave indexadoras separadas",
    "  APENAS por espaço (sem vírgulas).",
    "- Não repita nenhuma palavra dentro do próprio modelo.",
    "- Evite repetir palavras exatas já usadas no titulo_sugerido.",
    "- Prefira palavras complementares, sinônimos, variações e termos",
    "  de busca relacionados, somente quando forem seguros pelos dados.",
    "- Não invente marca, medida, material, compatibilidade ou benefício.",
    "- Não use conectivos inúteis: de, para, com, e, em, do, da, dos, das.",
    "- Não usar frase longa.",
    "- Faixa ideal entre 40 e 55 caracteres.",
    "- Se faltarem dados para complementar, retorne poucos termos seguros,",
    "  sem inventar.",
    "- Exemplo bom:",
    '  Título: "Barra Reta Aço Cromado 1,50m 25mm + Par Presilha"',
    '  Modelo: "long life olimpico musculacao academia anilha head liquidmetal radical anilhas furo olimpico barra olimpica 20kg barra hexagonal olimpico"',
    "- Exemplo ruim:",
    '  Modelo: "barra reta aço cromado 1,50m par presilha"',
    "",
    "Score SEO (0 a 100):",
